...
<body>
    ...
    <div id="mycontent">
       <div id="mycontent-top">
           ...
           <div class="content2">
         <img src="assets/img/avatars/48.jpg" class="content3">   
         <div class="content6">
             <div class="content4">
              Hello,${u.userName}
             </div>
              <button class="content5" id="edit">编辑资料</button>
         </div>     
         <div class="content7" id="ajax1">
            <ul>
                <li>昵称：${u.userName}</li>
                <li>年龄：${u.age} </li>
                <li>性别：${u.sex}</li>
                <li>星座：${u.constellations}</li>
                <li>爱好：${u.hobby}</li>
                <br><br>
                <li>职业：${u.occupation}</li>
                <li>邮箱：<span style="font-family: 宋体;">${u.email}</span></li>
                <li>地址：${u.address}</li>
                <li>公司：${u.company}</li>
                <li>个人标签：${u.labelling} </li>
            </ul>
         </div>  
      </div>
       </div>
