...
<body>
	...
	<div id="mycontent">
		<div id="mycontent-top">
			<i class="fa-strikethrough"></i> <span>马上借呗</span>
		...
		<div id="mycontent-left">
			...
			<ul id="email-nav" class="nav nav-pills nav-stacked">
				<li><a href="#"><i class="fa-money"></i> 闪电借款</a></li>
				<li><a href="#"><i class="st-align-center"></i> 我的借款</a></li>
			</ul>
		</div>
		...
		<div id="mycontent-right">
			...
			<div class="balance">
				<form action="loan">
					<h3>
						借款金额： 
						<input type="text" name="loanmoney">
					</h3>
