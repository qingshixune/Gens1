...
<head>
    ...
    <link href="css/fundRecord.css" rel="stylesheet" />
</head>
    ...
    <div id="mycontent">
        ...
        <div id="mycontent-left">
            ...
            <ul id="email-nav" class="nav nav-pills nav-stacked">
                <li><a href="email-inbox.html"><i class="st-clipboard"></i> 资金记录</a>
                </li>
        ...
        <div id="mycontent-right">
            ...
            <div class="balance">
                    ...
                    <div id="balance-bottom">
                    	<span>
                            <a href="fundRecord_genius.do?i=1" class="a_post" >&nbsp;首页&nbsp;</a>
                        </span>   
                        <c:if test="${i>1}">
                            <span>
                               <a href="fundRecord_genius.do?i=${next}" class="a_post">上一页</a>
                            </span>
                        </c:if>       
                        <c:forEach var="i" begin="1" end="${pages}">
                            <a href="fundRecord_genius.do?i=${i}" class="a_post">&nbsp;<!--${i}-->1&nbsp;</a>
                        </c:forEach>
                        <c:if test="${pages>i}">
                            <span>
                               <a href="fundRecord_genius.do?i=${next}" class="a_post">下一页</a>
                            </span>
                        </c:if>
                         <span>
                            <a href="fundRecord_genius.do?i=${pages}" class="a_post">&nbsp;尾页&nbsp;</a>
                        </span> 
                    </div> 
            </div>
        </div>
