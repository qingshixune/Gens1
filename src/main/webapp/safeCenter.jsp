...
<head>
    ...
    <link href="css/safeCenter.css" rel="stylesheet" />
</head>
    ...
    <div id="mycontent">
        ...
        <div id="mycontent-left">
            ...
            <ul id="email-nav" class="nav nav-pills nav-stacked">
                ...
                <li><a href="#"><i class="ec-pencil"></i>&nbsp;资料填写</a>
            </ul>
        </div>
        <div id="mycontent-right">
            ...
            <div class="content-show">实名信息提交后不可变更，请慎重填写！</div>
            <div class="content-center">
                <form name="refer" action="updateInfo">                 
                    <table cellspacing="0">
                        <tr>
                            <td>
                                真实姓名：
                            ...
                            <td>
                                <input type="text" name="userName" placeholder="请填写您的真实姓名" class="imInput">
                                <span class="imSpan">&nbsp;</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="idNumber" placeholder="请填写您的身份证号码" class="imInput">
                                <span class="imSpan">&nbsp;</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="password" name="payword" placeholder="请设置六位数字支付密码" class="imInput">
                                <span class="imSpan">&nbsp;</span>
                            </td>
                        </tr>
                    </table>
