...
<link href="assets/css/icons.css" rel="stylesheet" />
    ...
    <link href="css/Yu'ebao.css" rel="stylesheet" />    
</head>
<body>
    <!-- Start #header -->
    <div id="header">
                ...
                <div id="myRight-left-content">
                    <div id="myLeft-top">
                        <span>
                            ...
                            <b id="rechange">
                            	<a href="toYuebaoRechange" class="isA">
                                    转入
                            	</a>
                            </b>
                            <b id="withdraw">
                            	<a href="toYuebaoWithdraw" class="isA" id="isA">
                                    转出 
                            	</a>
                            </b>	
                            </p>	
                    ...
                    <div id="myLeft-bottom">
                        ...
                        <div id="aLine">
                            <table style="height:60px;border-color:gray;border-left-style:solid;border-width:2px"><tr><td valign="top"></td></tr></table>
                        </div>
                        <div id="myLeft-profit">
                            <span>不可用金额(元)</span>
                            <p>
                            	${list1.disableMoney }
