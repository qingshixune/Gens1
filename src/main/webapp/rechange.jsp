...
<head>
    ...
    <link href="css/rechangeAndWithdraw.css" rel="stylesheet" />    
</head>
<body>
    <!-- Start #header -->
    <div id="header">
        ...
        <div id="mycontent-right">
        	<div id="mycontent-right-top">
             ...
             <div class="login-form">
                <form action="rechange">
                    <h3>支付方式：
		    	<select name="cardNumber">
		    	<c:forEach var="list1" items="${list}">
		    	    <option value="${list1.cardNumber}">${list1.cardNumber}</option>
		    	</c:forEach>
		        </select>
		    </h3>
                    <h3>充值金额 : <input type="text" name="transfer" placeholder="请输入充值金额" id="imInput">
                    <p id="imP">&nbsp;</p>
		    </h3>
                    <h3>
    ...
    <script src="js/rechangeAndWithdraw.js" type="text/javascript"></script>
</body>
