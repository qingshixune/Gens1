...
<body>
    ...
    <div id="mycontent">
       ...
       <div id="mycontent-left">
            ...
            <ul id="email-nav" class="nav nav-pills nav-stacked">
                 <li><a href="email-inbox.html"><i class="en-credit-card"></i> 银行卡管理</a>
                 </li>
                 <li><a href="#"><i class="st-folder-add"></i>银行卡添加</a>
            </ul>
        </div>
        ...
        <div id="mycontent-right">
            ...
            <div class="content-center">
                <div class="center-right">
                    <p id="rechange">
                        <a href="toRechange">充值</a>
                    </p>
                    <p id="add">
                        <a href="toAddCard">添加</a>
                    </p>
                </div>
                    <table>
                    <tr><td>发卡银行</td><td>银行卡编号</td></tr>
                        <c:forEach var="list1" items="${list}">
                        
                        <tr>
                            <td><input type="hidden" name="cardType" value="${list1.cardType}">
                           ${list1.cardType}</td>
                            <td>${list1.cardNumber }</td>
                            <td><a href="deleteCard?cardNumber=${list1.cardNumber}" 
                                 class="delete">解绑</a></td>
                        </tr>
                        </c:forEach>
                    </table>
            </div> 
    ...
    <script type="text/javascript" src="js/cardManage.js"></script>
</body>
